        ...
        this.description = {
            ...
            properties: [
                ...
                },
                {
                    ...
                    description: "File name the recipient sees. Clear the field to use the binary file's own name, or the file name at the end of the URL, when that looks like a real file name; otherwise the document is named document.pdf.",
                },
                // Send Audio fields
                {
