        ...
        this.description = {
            ...
            properties: [
                    ...
                    options: [
                        {
                            ...
                            type: 'boolean',
                            default: false,
                            description: 'Whether to decline every incoming call automatically. Re-read on each call, so it applies immediately. Baileys only: whatsapp-web.js cannot reject a call.',
                        },
                        {
                        ...
                        },
                        {
                            ...
                            default: 5000,
                            description: "Base backoff between the gateway's reconnect attempts, in milliseconds, with the same engine scope as Max Reconnect Attempts. Applies from the next Start.",
                        },
                    ],
                },
                {
                ...
                },
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            ...
                            type: 'string',
                            default: '',
                            description: 'Return only the session with exactly this name (case-sensitive). No match returns an empty list, which is no items on node version 2. Requires OpenWA ≥ 0.23.5; an older server ignores it and returns every session.',
                        },
                        {
                            displayName: 'Offset',
                            name: 'offset',
                ...
                },
                {
                    ...
                    description: "Name the recipient sees. Left empty, a binary source keeps the file's own name and a URL source takes the file name at the end of its path, when either looks like a real file name (a short extension, not a server script); otherwise, and for base64, it is document.pdf.",
                },
                // Send Audio fields
                {
                ...
                },
                {
                    ...
                    description: 'The full serialized ID of the target message, as returned by send operations or delivered by the Trigger. For Click Button, the ID of the prompt that offered the buttons.',
                },
                {
                    ...
                    description: 'The ID of the choice to tap, taken from the <code>buttons</code> list the prompt carried on the Message Received event. Buttons that open a URL or dial a number cannot be clicked.',
                },
                {
                    ...
                    default: '',
                    displayOptions: { show: { resource: ['message'], operation: ['clickButton'] } },
                    description: 'Visible label of the choice. Leave empty to have OpenWA read it from the stored prompt.',
                },
                {
                    displayName: 'Click Button needs OpenWA ≥ 0.23.6 on the Baileys engine; whatsapp-web.js answers 501. It sends a structured reply quoted to the prompt rather than a native tap, so WhatsApp may still treat it differently. The prompt must still be in the engine store: an older or evicted one answers 404.',
                ...
                },
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            ...
                            default: 3,
                            description: 'Total delivery attempts per event, including the first, from 0 to 5. 0 and 1 both mean a single attempt with no retry.',
                        },
                    ],
                },
                {
                ...
                },
                {
                    ...
                    description: 'At least one is required. The write replaces the whole label, so on an existing label a field left out is not preserved: set both to keep both.',
                    options: [
                        {
                            displayName: 'Name',
                            name: 'labelName',
                ...
                },
                {
                    ...
                    description: "The ID of the call, as delivered by the Trigger's call events. Baileys only: whatsapp-web.js answers 501 (OpenWA ≥ 0.23.6; older servers reported a rejection that did not stop the call ringing).",
                },
                {
